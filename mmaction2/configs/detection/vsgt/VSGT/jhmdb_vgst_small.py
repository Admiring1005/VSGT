...
model = dict(
    ...
    backbone=dict(
        ...
        # arch='tiny',
        pretrained='/root/mmaction2/checkpoints/video-sgformer-kinetecis400.pth',
        sr_ratios=(8, 4, 2, 1),
        embed_dims=64,
        num_heads=(2, 4, 8, 16),
        depths=(2, 4, 16, 1),
...
data_root = 'data/jhmdb/Frames'
anno_root = 'data/jhmdb/multisports_anno'
...
train_pipeline = [
    dict(type='SampleAVAFrames', clip_len=16, frame_interval=1),
...
val_pipeline = [
    dict(
        type='SampleAVAFrames', clip_len=16, frame_interval=1, test_mode=True),
    dict(type='RawFrameDecode', **file_client_args),
...
#     type='AmpOptimWrapper',
#     optimizer=dict(
#         type='AdamW', lr=1.875e-4, betas=(0.9, 0.999), weight_decay=0.02),
#     constructor='SwinOptimWrapperConstructor',
#     paramwise_cfg=dict(
#         absolute_pos_embed=dict(decay_mult=0.),
#         relative_position_bias_table=dict(decay_mult=0.),
...
work_dir = './work_dirs/jhmdb_vgst_base'  # noqa: E501
