...
data_root = 'data/ucf/rawframes'
anno_root = 'data/ucf/ucf_ava_annotations'
...
exclude_file_train = f'{anno_root}/ava_val_excluded_timestamps_v2.1.csv'
...
work_dir = './work_dirs/ucf_vgst_base'  # noqa: E501
